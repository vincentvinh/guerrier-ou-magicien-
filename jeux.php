    ...
    else
    {
      ...
      switch ($retour)
      {
        ...
        case Personnage::PERSO_ENDORMI :
          $message = 'vous etes endormis';
          break;
        
        case Personnage::TROIS_COUPS :
          $message = 'vous avez déjà frappeé trois fois il est lheure de dormir!';
          $perso->dodo($perso);
          break;
      ...
      switch ($baton)
      {
       ...
       case Personnage::PERSO_TUE_APRES_ATTAK :
        
          $manager->delete($perso);
          $message = 'Vous vous etes tué !';
          break;
